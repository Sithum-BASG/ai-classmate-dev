...
class _TutorClassesPageState extends State<TutorClassesPage> {
          ...
          children: [
            ...
            Expanded(
              child: Builder(builder: (context) {
                ...
                return TabBarView(
                  children: [
                    _buildClassesList(user.uid, 'published'),
                    _buildClassesList(user.uid, 'draft'),
                  ],
                );
              }),
            ),
  ...
  Widget _buildClassesList(String uid, String status) {
    ...
    return StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
      ...
      builder: (context, snapshot) {
        ...
        if (docs.isEmpty) {
          return Center(
              child: Text(status == 'published'
                  ? 'No published classes yet.'
                  : 'No drafts. Tap New Class.'));
        }
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return Container(
              ...
              child: InkWell(
                onTap: () => context.push('/tutor/class/${doc.id}'),
                borderRadius: BorderRadius.circular(12),
                child: Padding(
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          if (status == 'draft')
                            TextButton.icon(
                              onPressed: () => _publishClass(doc.id),
